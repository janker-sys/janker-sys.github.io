...
$.ajax({
  ...
  data: {
    key: 'LY5BZ-BPGK7-6AGXQ-HEK6K-E4SMZ-IEBWP',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://tuchuang.voooe.cn/images/2024/10/16/download.webp' title='上班摸鱼ing~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://tuchuang.voooe.cn/images/2024/10/16/download.webp' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://api.yimian.xyz/img?type=moe&size=1920x1080);
    --darkmode-bg:url(https://api.yimian.xyz/img?type=moe&size=1920x1080);
    --mobileday-bg: url(https://api.yimian.xyz/img?type=moe&size=1920x1080);
    --mobilenight-bg: url(hhttps://api.yimian.xyz/img?type=moe&size=1920x1080);
  }`;
}
// 切换背景主函数
function changeBg(s) {
